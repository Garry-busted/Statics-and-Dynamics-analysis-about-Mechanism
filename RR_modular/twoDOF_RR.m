...
G = 1;
for i = 1:length(time)
    [L2(i),L3(i),h2(i),h3(i),Q(i),P(i),tQ(i),tP(i)] = preForceRR(r2,q2(i),q3(i),phi2,phi3,m2,m3,b2,b3,I2,I3,q2d(i),q3d(i),q2dd(i),q3dd(i));
    [F32(i),F32t(i),F32n(i),Fex(i),Fey(i),F12x(i),F12y(i)] = ForceRR(P(i),Q(i),T2_torque(i),T3_torque(i),r2,r3,L2(i),L3(i),h2(i),h3(i),q2(i),q3(i),tP(i),tQ(i),m2,m3,b2,b3,phi2,phi3,G);
